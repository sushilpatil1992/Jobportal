        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    db.SaveChanges();
                    if(model.RoleName=="Jobseeker")
                    {
                    var profile = new Profile { Name = model.FirstName, ApplicationUserId = user.Id, LName = model.LastName, Email = model.Email };
                    ...
                    {
                        var profile = new EmpProfile { Name = model.FirstName, ApplicationUserId = user.Id, LName = model.LastName, Email = model.Email };

                        db.EmpProfiles.Add(profile);
                        db.SaveChanges();
                    }
