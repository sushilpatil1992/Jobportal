...
namespace AspNetGroupBasedPermissions.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        private const string InitialUserFirstName = "FirstName";
        private const string InitialUserLastName = "LastName";
        private const string InitialUserEmail = "test@test.com";
        private const string InitialUserPassword = "password";
        ...
        private void AddRoles()
        {
            ...
            _idManager.CreateRole("Jobseeker", "Restricted to business domain activity");
            _idManager.CreateRole("Employee", "Restricted to business domain activity");
        }
